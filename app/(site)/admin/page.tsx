...
export default async function AdminPage({ searchParams }: AdminPageProps) {
  ...
  const [subjects, requests, selectedRequest, catalog] = await Promise.all([
  ...
  return (
    <AppShell
      ...
      currentPathHint="Review publication requests, moderate shared catalog content, and inspect submission snapshots."
    >
